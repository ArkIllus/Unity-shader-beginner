...
Shader "Unity Shaders Book/Chapter 7/Error-Normal Map In World Space"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            CGPROGRAM
// Upgrade NOTE: excluded shader from DX11; has structs without semantics (struct v2f members worldLightDir,worldViewDir)
#pragma exclude_renderers d3d11
            ...
            struct v2f
            {
                ...
                //错误的尝试：
                float3 worldLightDir; //不用fixed3
                float3 worldViewDir; //不用fixed3
            };
